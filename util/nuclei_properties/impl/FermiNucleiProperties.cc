...
#include "util/nuclei_properties/data_storage/G4FermiDefaultNuclearMass.hh"
...
namespace {
  G4FermiFloat WeitzsaeckerBindingEnergy(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber) {
  ...
  G4FermiFloat EstimateAtomicWeight(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber) {
    ...
    return G4FermiFloat(G4FermiInt(atomicMass) - G4FermiInt(chargeNumber)) * neutronMassExcess
        + G4FermiFloat(chargeNumber) * hydrogenMassExcess - WeitzsaeckerBindingEnergy(atomicMass, chargeNumber)
  ...
  G4FermiFloat EstimateNuclearMass(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber) {
    ...
    mass += (
      14.4381 * std::pow(G4FermiFloat(chargeNumber), 2.39) 
...
FermiNucleiProperties::FermiNucleiProperties()
  : FermiNucleiProperties(G4FermiDefaultNuclearMass())
{
}

G4FermiFloat FermiNucleiProperties::GetNuclearMass(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber) const {
...
bool FermiNucleiProperties::IsStable(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber) const {
...
void FermiNucleiProperties::AddStableNuclei(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber, G4FermiFloat mass) {
  ASSERT_MSG(G4FermiUInt(atomicMass) >= G4FermiUInt(chargeNumber),
...
void FermiNucleiProperties::AddStableNuclei(G4FermiNucleiData nucleiData, G4FermiFloat mass) {
