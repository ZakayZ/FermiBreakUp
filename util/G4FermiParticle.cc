...
#include "nuclei_properties/G4FermiNucleiProperties.hh"
...
G4FermiParticle::G4FermiParticle(G4FermiAtomicMass atomicMass, G4FermiChargeNumber chargeNumber, const G4FermiLorentzVector& momentum)
