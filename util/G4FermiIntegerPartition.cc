...
G4FermiIntegerPartition::G4FermiIntegerPartition(uint32_t number, uint32_t termsCount, uint32_t base)
  : number_(number)
...
bool G4FermiIntegerPartition::Iterator::operator==(const G4FermiIntegerPartition::Iterator& other) const {
