...
//           + G4FermiFloat(atomicMass) * amu_c2;
// }
...
//   mass -= G4FermiFloat(chargeNumber) * electron_mass_c2;
...
G4FermiFloat G4FermiNucleiProperties::GetNuclearMassImpl(G4FermiAtomicMass atomicMass,
